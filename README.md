# @diotoborg/voluptate-sequi-natus
...
__Motto of `@diotoborg/voluptate-sequi-natus` is simple__: *create the smallest possible CSS-in-JS library and provide all features of any other library through addons.*

- __Only [0.5 Kb](https://bundlephobia.com/result?p=@diotoborg/voluptate-sequi-natus@1.15.3)__ in base configuration, *e.g. [`styled-components`](https://github.com/styled-components/styled-components) is [15.1Kb](https://bundlephobia.com/result?p=styled-components@3.2.5)*
...
> For pre-configured simple-to-use package see [`nano-theme`](https://github.com/streamich/nano-theme), which builds on top of `@diotoborg/voluptate-sequi-natus`.
...
[npm-url]: https://www.npmjs.com/package/@diotoborg/voluptate-sequi-natus
[npm-badge]: https://img.shields.io/npm/v/@diotoborg/voluptate-sequi-natus.svg
[travis-url]: https://travis-ci.org/streamich/@diotoborg/voluptate-sequi-natus
[travis-badge]: https://travis-ci.org/streamich/@diotoborg/voluptate-sequi-natus.svg?branch=master
